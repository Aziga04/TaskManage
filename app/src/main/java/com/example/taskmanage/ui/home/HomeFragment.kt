package com.example.taskmanage.ui.home
...
import com.example.taskmanage.App
import com.example.taskmanage.R
import com.example.taskmanage.databinding.FragmentHomeBinding
import com.example.taskmanage.model.Task

import com.example.taskmanage.ui.home.adapter.TaskAdapter
...
class HomeFragment : Fragment() {
    ...
    private fun onCLick(task: Task){
        findNavController().navigate(R.id.navigation_TaskFragment, bundleOf(KEY_FOR_TASK to task))
    }
